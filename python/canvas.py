...
class Color():
    def __init__(self):
        ...
        self.dr = random.randint(-3, 6)
        self.g = random.randint(0, 255)
        self.dg = random.randint(-3, 6)
        self.b = random.randint(0, 255)
        self.db = -random.randint(-3, 6)
    ...
    def next(self):
        self.r, self.dr = self.advance(self.r, self.dr)
        self.g, self.dg = self.advance(self.g, self.dg)
        self.b, self.db = self.advance(self.b, self.db)
